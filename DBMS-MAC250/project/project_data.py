...
query5 = """INSERT INTO treatments VALUES
            ('P1','M1','1111','2025-01-11'),
            ('P1','M1','2222','2025-01-12'),
            ('P2','M2','1111','2025-01-11'),
            ('P2','M3','2222','2025-01-21'),
            ('P2','M2','3333','2025-01-30'),
            ('P2','M3','4444','2025-02-01'),
            ('P2','M2','5555','2025-01-10'),
            ('P4','M4','1111','2025-01-11'),
            ('P4','M4','6666','2025-01-21'),
            ('P4','M4','7777','2025-01-30'),
            ('P4','M4','1111','2025-02-11'),
            ('P5','M1','8888','2025-01-11'),
            ('P5','M1','7777','2025-01-21'),
            ('P5','M2','6666','2025-01-30'),
            ('P5','M5','5555','2025-01-30'),
            ('P5','M5','4444','2025-02-11'),
            ('P6','M1','1111','2025-01-11');"""
